...
public class CourseController {
    ...
    public List<Customer> getAllCustomersFromTownForCourse(@PathVariable Long id, String town){
        return courseRepository.getAllCustomersFromTownForCourse(id, town);
    }
